            ...
            <form action="" class="w-full h-full flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full h-12.5 flex p-2 items-center border-2 border-Subtitulos">
                            <div class="h-5 w-5"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <div class="flex gap-3">
                    <a href="" class="w-full h-12.5 p-4 bg-Subtitulos hover:bg-Titulos flex items-center duration-300">
                        <img src="./images/Google_Logo.png" alt="" class="w-10 h-10">
                        <p class="text-md text-Backgrounds02 font-medium pl-2">Cadastra-se com o Google</p>
                    </a>
                    <a href="" class="w-full h-12.5 p-4 bg-Subtitulos hover:bg-Titulos flex items-center duration-300">
                        <img src="./images/Facebook_Logo.png" alt="" class="w-10 h-10">
